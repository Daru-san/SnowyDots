...
in with lib; {
    ...
    android = {
      ...
      mtp = {
        gvfs.enable = mkEnableOption
          "Enable gvfs for automounting android devices using mtp";
        jmtpfs.enable = mkEnableOption
          "Enable jmtpfs for manual mounting android devices using mtp";
      };
  ...
  config = {
    ...
    environment.systemPackages = with pkgs;
      mkIf cfg.mtp.jmtpfs.enable [ jmtpfs ];
